...
- ノード登録名は `UkkeyHG-RPG-Monster-Generator`、表示名は `RPG Monster Generator (UkkeyHG)`、カテゴリは `UkkeyHG/RPG`。
...
- **このカスタムノード**: `C:\Project\ComfyUI\custom_nodes\UkkeyHG-RPG-Monster-Generator\`
