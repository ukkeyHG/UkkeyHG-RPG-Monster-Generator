...
MONSTER_ELEMENT_DATA = {
    ...
    "Fire": {
        "prompt": "(creature's entire fur, skin, and body deeply colored crimson red with ember orange accents:1.3), (visible burning crimson flames erupting from the creature's body, prominent flame tongues licking and covering the body, body wreathed in raging fire on the body only:1.5), (every surface of the body tinted with fiery red and ember orange:1.3), glowing red-hot accents with molten cracks across the body, flickering flame tongues rising from the body, smoldering crimson glow on the creature, heat haze rising from the body itself",
    ...
    "Ice": {
        "prompt": "(creature's entire fur, skin, and body deeply colored pale ice blue and frosty white:1.5), (the creature's body completely encrusted with thick crystalline frost coating on the body surface only:1.5), (every surface of the body deeply tinted icy pale blue and white with visible frost patterns:1.4), frozen blue glow across the skin, thick crystalline frost coating the body, frosty breath puffing from the mouth, frozen aura clinging tightly to the body, ice crystals forming on the body surface",
    ...
    "Dark": {
        "prompt": "(creature's entire fur, skin, and body deeply colored pitch black and absolute void darkness:1.5), (the creature's body completely wrapped in shadowy jet black aura on the body surface only:1.5), (every surface of the body deeply tinted absolute pitch black and deep shadow:1.4), dark mist clinging tightly to the skin, swirling jet black void energy on the body only, abyssal silhouette, glowing dark eyes, shadow tendrils emanating from the body only, deep shadow purple highlights only at the edges of the silhouette",
        "negative_prompt": "holy halo, divine angelic aura, shining sun rays on creature, bright natural fur, vivid bright purple body color, neon purple skin, magenta hue dominating, shadow puddles on the floor, dark patches on the ground, void cracks on the floor, outdoor void abyss landscape, abyssal cosmic background, scene replaced by void environment"
    },
    "Light": {
    ...
    "Metal": {
        "prompt": "(creature's entire body composed of solid polished chrome silver metal, no flesh visible, no fur visible, no organic surface visible, completely metallic body:1.6), (the creature's body fully covered in shiny burnished steel and iron plating fused to the form:1.5), (every surface of the body replaced with reflective metallic plating with rivets and steel armor segments:1.4), mirror-like reflective chrome skin, polished steel sheen on the entire body, cold hardened iron texture covering the creature, hammered metal plating with visible seams and rivets, statue-like solid metal form, brushed steel highlights",
