...
- **Cerberus**: 巨大な単頭の地獄の番犬（ヘルハウンド）。冥界ハデスの門の番をする黒毛の魔犬。 ※ SDXL の制約により多頭表現は不安定なため、本実装では**単頭ヘルハウンド**として描画。
...
| **Cerberus** | 単頭の巨大ヘルハウンドとして描画（SDXL は多頭の安定描画が困難なため簡略化）。Wolf 級の framing 強化と四足獣化、黒毛と燃える琥珀眼で「地獄の番犬」感を確保。 |
